...
{	
	...
	public partial class IM_UserGroupBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<IM_UserGroupEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public IM_UserGroupEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, IM_UserGroupEntity oneEntity)
        {
            try
            {
