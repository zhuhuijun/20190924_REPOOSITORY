...
{	
	...
	public partial class WF_DelegateRuleSchemeInfoBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_DelegateRuleSchemeInfoEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_DelegateRuleSchemeInfoEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_DelegateRuleSchemeInfoEntity oneEntity)
        {
            try
            {
