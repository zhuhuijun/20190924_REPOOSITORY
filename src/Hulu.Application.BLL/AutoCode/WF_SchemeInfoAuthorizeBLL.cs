...
{	
	...
	public partial class WF_SchemeInfoAuthorizeBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_SchemeInfoAuthorizeEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_SchemeInfoAuthorizeEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_SchemeInfoAuthorizeEntity oneEntity)
        {
            try
            {
