...
{	
	...
	public partial class Client_CashBalanceBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Client_CashBalanceEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Client_CashBalanceEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Client_CashBalanceEntity oneEntity)
        {
            try
            {
