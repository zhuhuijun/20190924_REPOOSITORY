...
{	
	...
	public partial class Base_ModuleColumnBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_ModuleColumnEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_ModuleColumnEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_ModuleColumnEntity oneEntity)
        {
            try
            {
