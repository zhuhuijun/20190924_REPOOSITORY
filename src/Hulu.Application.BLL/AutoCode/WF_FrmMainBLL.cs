...
{	
	...
	public partial class WF_FrmMainBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_FrmMainEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_FrmMainEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_FrmMainEntity oneEntity)
        {
            try
            {
