...
{	
	...
	public partial class Client_ReceivableBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Client_ReceivableEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Client_ReceivableEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Client_ReceivableEntity oneEntity)
        {
            try
            {
