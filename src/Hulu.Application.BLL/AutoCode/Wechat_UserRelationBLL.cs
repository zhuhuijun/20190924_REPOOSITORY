...
{	
	...
	public partial class Wechat_UserRelationBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Wechat_UserRelationEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Wechat_UserRelationEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Wechat_UserRelationEntity oneEntity)
        {
            try
            {
