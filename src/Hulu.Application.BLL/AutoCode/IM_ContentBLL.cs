...
{	
	...
	public partial class IM_ContentBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<IM_ContentEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public IM_ContentEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, IM_ContentEntity oneEntity)
        {
            try
            {
