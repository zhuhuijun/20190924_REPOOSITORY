...
{	
	...
	public partial class WF_ProcessInstanceBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_ProcessInstanceEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_ProcessInstanceEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_ProcessInstanceEntity oneEntity)
        {
            try
            {
