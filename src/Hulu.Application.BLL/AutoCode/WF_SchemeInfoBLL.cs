...
{	
	...
	public partial class WF_SchemeInfoBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_SchemeInfoEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_SchemeInfoEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_SchemeInfoEntity oneEntity)
        {
            try
            {
