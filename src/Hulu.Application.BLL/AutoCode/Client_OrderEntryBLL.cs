...
{	
	...
	public partial class Client_OrderEntryBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Client_OrderEntryEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Client_OrderEntryEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Client_OrderEntryEntity oneEntity)
        {
            try
            {
