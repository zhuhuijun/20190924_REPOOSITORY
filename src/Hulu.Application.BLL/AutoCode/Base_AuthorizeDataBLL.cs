...
{	
	...
	public partial class Base_AuthorizeDataBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_AuthorizeDataEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_AuthorizeDataEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_AuthorizeDataEntity oneEntity)
        {
            try
            {
