...
{	
	...
	public partial class Base_DepartmentBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_DepartmentEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_DepartmentEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_DepartmentEntity oneEntity)
        {
            try
            {
