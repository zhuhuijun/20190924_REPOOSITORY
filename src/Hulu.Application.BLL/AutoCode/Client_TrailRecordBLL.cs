...
{	
	...
	public partial class Client_TrailRecordBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Client_TrailRecordEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Client_TrailRecordEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Client_TrailRecordEntity oneEntity)
        {
            try
            {
