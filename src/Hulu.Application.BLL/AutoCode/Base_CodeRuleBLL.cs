...
{	
	...
	public partial class Base_CodeRuleBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_CodeRuleEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_CodeRuleEntity oneEntity)
        {
            try
            {
