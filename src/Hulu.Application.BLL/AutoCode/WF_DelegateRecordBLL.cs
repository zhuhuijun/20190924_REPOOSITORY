...
{	
	...
	public partial class WF_DelegateRecordBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_DelegateRecordEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_DelegateRecordEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_DelegateRecordEntity oneEntity)
        {
            try
            {
