...
{	
	...
	/// Base_AreaBLL
	/// </summary>	
	public partial class Base_AreaBLL
    {
		private IBase_AreaService service = new Base_AreaService();
        /// <summary>
        /// GetList
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Base_AreaEntity> GetList()
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_AreaEntity oneEntity)
        {
            try
            {
