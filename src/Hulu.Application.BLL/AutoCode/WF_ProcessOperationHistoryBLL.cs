...
{	
	...
	public partial class WF_ProcessOperationHistoryBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_ProcessOperationHistoryEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_ProcessOperationHistoryEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_ProcessOperationHistoryEntity oneEntity)
        {
            try
            {
