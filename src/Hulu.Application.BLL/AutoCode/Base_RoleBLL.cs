...
{	
	...
	public partial class Base_RoleBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_RoleEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_RoleEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_RoleEntity oneEntity)
        {
            try
            {
