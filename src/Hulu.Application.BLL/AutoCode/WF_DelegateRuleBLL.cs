...
{	
	...
	public partial class WF_DelegateRuleBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_DelegateRuleEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_DelegateRuleEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_DelegateRuleEntity oneEntity)
        {
            try
            {
