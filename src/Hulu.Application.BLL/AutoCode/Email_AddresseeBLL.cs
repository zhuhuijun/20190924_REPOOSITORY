...
{	
	...
	public partial class Email_AddresseeBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Email_AddresseeEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Email_AddresseeEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Email_AddresseeEntity oneEntity)
        {
            try
            {
