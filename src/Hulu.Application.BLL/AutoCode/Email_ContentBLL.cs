...
{	
	...
	public partial class Email_ContentBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Email_ContentEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Email_ContentEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Email_ContentEntity oneEntity)
        {
            try
            {
