...
{	
	...
	public partial class Base_UserRelationBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_UserRelationEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_UserRelationEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_UserRelationEntity oneEntity)
        {
            try
            {
