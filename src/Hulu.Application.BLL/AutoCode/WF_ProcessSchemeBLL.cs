...
{	
	...
	public partial class WF_ProcessSchemeBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<WF_ProcessSchemeEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public WF_ProcessSchemeEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, WF_ProcessSchemeEntity oneEntity)
        {
            try
            {
