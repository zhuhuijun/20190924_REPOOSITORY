...
{	
	...
	public partial class Base_ModuleFormInstanceBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_ModuleFormInstanceEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_ModuleFormInstanceEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_ModuleFormInstanceEntity oneEntity)
        {
            try
            {
