...
{	
	...
	public partial class Client_ChanceBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Client_ChanceEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Client_ChanceEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Client_ChanceEntity oneEntity)
        {
            try
            {
