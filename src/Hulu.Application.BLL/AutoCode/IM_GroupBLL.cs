...
{	
    ...
    {
		private IIM_GroupService service = new IM_GroupService();
        /// <summary>
        /// GetList
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IM_GroupEntity> GetList()
        {
        ...
        /// <returns></returns>
        public IEnumerable<IM_GroupEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public IM_GroupEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, IM_GroupEntity oneEntity)
        {
            try
            {
