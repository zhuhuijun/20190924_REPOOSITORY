...
{	
	...
	public partial class Base_ModuleButtonBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_ModuleButtonEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_ModuleButtonEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_ModuleButtonEntity oneEntity)
        {
            try
            {
