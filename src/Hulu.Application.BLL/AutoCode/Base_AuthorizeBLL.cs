...
{	
	...
	public partial class Base_AuthorizeBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Base_AuthorizeEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Base_AuthorizeEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Base_AuthorizeEntity oneEntity)
        {
            try
            {
