...
{	
	...
	public partial class TestFlow_LeaveslipBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<TestFlow_LeaveslipEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public TestFlow_LeaveslipEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TestFlow_LeaveslipEntity oneEntity)
        {
            try
            {
