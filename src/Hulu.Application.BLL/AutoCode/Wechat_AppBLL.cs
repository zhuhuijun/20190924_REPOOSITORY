...
{	
	...
	public partial class Wechat_AppBLL
    {
        ...
        /// <returns></returns>
        public IEnumerable<Wechat_AppEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public Wechat_AppEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Wechat_AppEntity oneEntity)
        {
            try
            {
