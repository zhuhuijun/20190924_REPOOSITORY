...
{	
	...
	/// IBase_UserService
	/// </summary>	
	public partial class Base_UserService : RepositoryFactory<Base_UserEntity>,IBase_UserService
    {
        /// <summary>
        /// GetList
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Base_UserEntity> GetList_Auto()
        {
        ...
        /// <returns></returns>
        public Base_UserEntity GetEntity_Auto(string keyValue)
        {
        ...
        /// <returns></returns>
        public IEnumerable<Base_UserEntity> GetPageList_Auto(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<Base_UserEntity>();
        ...
        /// <returns></returns>
        public void SaveForm_Auto(string keyValue, Base_UserEntity oneEntity)
        {
