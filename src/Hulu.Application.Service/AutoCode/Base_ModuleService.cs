...
{	
	...
	/// IBase_ModuleService
	/// </summary>	
	public partial class Base_ModuleService : RepositoryFactory<Base_ModuleEntity>,IBase_ModuleService
    {
        /// <summary>
        /// GetList
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Base_ModuleEntity> GetList_Auto()
        {
        ...
        /// <returns></returns>
        public Base_ModuleEntity GetEntity_Auto(string keyValue)
        {
        ...
        /// <returns></returns>
        public IEnumerable<Base_ModuleEntity> GetPageList_Auto(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<Base_ModuleEntity>();
        ...
        /// <returns></returns>
        public void SaveForm_Auto(string keyValue, Base_ModuleEntity oneEntity)
        {
