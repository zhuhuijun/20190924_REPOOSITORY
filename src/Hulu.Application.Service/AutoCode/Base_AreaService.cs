...
{	
	...
	/// IBase_AreaService
	/// </summary>	
	public partial class Base_AreaService : RepositoryFactory<Base_AreaEntity>,IBase_AreaService
    {
        /// <summary>
        /// GetList
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Base_AreaEntity> GetList_Auto()
        {
        ...
        /// <returns></returns>
        public Base_AreaEntity GetEntity_Auto(string keyValue)
        {
        ...
        /// <returns></returns>
        public IEnumerable<Base_AreaEntity> GetPageList_Auto(Pagination pagination, string queryJson)
        {
            var expression = LinqExtensions.True<Base_AreaEntity>();
        ...
        /// <returns></returns>
        public void SaveForm_Auto(string keyValue, Base_AreaEntity oneEntity)
        {
